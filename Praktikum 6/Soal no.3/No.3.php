...
require_once '../Abstrack and interface/Abstrack.php';
require_once '../Abstrack and interface/interface.php';
...
$singa = new Animal('Gajah');
$manusia = new Homosapiens('Alex');
$airplane2 = new Airplane2(20000, 'Air Asia');
$superman2 = new Superman2('Thor');