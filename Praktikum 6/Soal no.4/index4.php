...
<body>
        ...
        <div class="container">
  <div class="row">
  <h4 class="text-center">Soal No.4</h4>
    <div >
                <h4>-----------------------------------</h4>
                <?= $riverBarge2->getMaxLoad(); ?> <br>
                <?= $riverBarge2->addBox(15000); ?> <br>
                <?= $riverBarge2->addBox(17000); ?> <br>
                <?= $riverBarge2->addBox(4000); ?> <br>
                <?= $riverBarge2->addBox(4000); ?> <br>
                <?= $riverBarge2->dock(); ?> <br>
    ...
    <div>
                ...
                <?= $seaPlane->addBox(15000); ?> <br>
                <?= $seaPlane->addBox(10000); ?> <br>
                <?= $seaPlane->addBox(5000); ?> <br>
                <?= $seaPlane->dock(); ?> <br>
                <?= $seaPlane->cruise(); ?> <br>
                <?= $seaPlane->takeOff(); ?> <br>
                <?= $seaPlane->fly(); ?> <br>
    ...
    <div>
                ...
                <?= $helicopter->addBox(10000); ?> <br>
                <?= $helicopter->addBox(6000); ?> <br>
                <?= $helicopter->addBox(4000); ?> <br>
